...
<html>
  <head>
	...
	<script type="text/javascript" src="js/topic_result_list.js"></script>
  ...
  <body>
			...
			<table class="table left">
				<tr class="border-none">
					<td class="border-none">
						...
						<button type="button" id="button_output"
							class="btn btn-primary btn-sm">
							<span class="glyphicon glyphicon-repeat"></span>导出文件
						</button> &nbsp;&nbsp;
						 查看: <label><input name="Choose"
							type="radio" value="0" checked />待评审选题 </label> &nbsp;&nbsp; <label><input
							name="Choose" type="radio" value="1" />已评审选题 </label>&nbsp;&nbsp;每页记录<input
			...
			<div class="modal-content">
				<form action="" method="get" class="form-horizontal">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="formTitle">选题评审</h4>
					</div>
					<div class="modal-body" id="formInfor">
		                    <div class="form-group">
		                        <label class="col-sm-2 control-label">选题名称：</label>
		                        <div class="col-sm-10">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#button_output").click(output_file);
