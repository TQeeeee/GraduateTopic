...
<script type="text/javascript" src="js/student_topic_list.js"></script>
		...
		<div class="modal-dialog width-600">
			...
			<form action="" method="get" class="form-horizontal">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="formTitle">查看选题</h4>
					</div>
					<div class="modal-body" id="formInfor">
		                    <div class="form-group">
		                        <label class="col-sm-3 control-label">选题名称：</label>
		                        <div class="col-sm-9">
		                            <textarea class="form-control" rows="2" id="Ttitle" readonly></textarea>
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="col-sm-3 control-label">专业方向：</label>
		                        <div class="col-sm-9">
		                            <input type="text" class="form-control" id="Tmajor" readonly>
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label  class="col-sm-3 control-label">选题简介：</label>
		                        <div class="col-sm-9">
		                            <textarea class="form-control" rows="3" id="Tsummary" readonly></textarea>
		                        </div>
		                    </div>
